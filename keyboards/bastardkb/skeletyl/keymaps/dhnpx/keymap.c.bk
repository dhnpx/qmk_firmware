...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1] = LAYOUT_split_3x5_3(
        ...
        KC_NO, KC_RBRC, KC_LBRC, KC_NO, KC_NO,                                      KC_COMM, KC_1, KC_2, KC_3, KC_DOT,
                        KC_TRNS, KC_SPC, KC_TRNS,                           MO(5), KC_0, KC_TRNS
    ),
	[2] = LAYOUT_split_3x5_3(
        KC_TILD, KC_AT, KC_HASH, KC_DLR, KC_PERC,                       KC_CIRC, KC_AMPR, KC_LPRN, KC_RPRN, KC_GRV,
        KC_EXLM, KC_PLUS, KC_MINS, KC_EQL, KC_PIPE,                     KC_NO, OSM(MOD_LSFT), OSM(MOD_LGUI), OSM(MOD_LALT), OSM(MOD_LCTL),
        KC_SLSH, KC_QUES, KC_ASTR, KC_UNDS, KC_BSLS,                    KC_NO, KC_NO, KC_LCBR, KC_RCBR, KC_NO,
	...
	[3] = LAYOUT_split_3x5_3(
        ...
        KC_NO, KC_CUT, KC_COPY, KC_PSTE, KC_NO,                                     KC_NO, KC_BSPC, KC_NO, KC_NO, KC_NO,
                                        KC_TRNS, KC_SPC, KC_TRNS,                   KC_TRNS, KC_BSPC, MO(4)
    ),
	[4] = LAYOUT_split_3x5_3(
        ...
        KC_F9, KC_F10, KC_F11, KC_F12, KC_NO,                   KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
                                    MO(3), KC_SPC, KC_TRNS, KC_TRNS, KC_BSPC, KC_TRNS),
