...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_split_3x5_3(
        KC_NO, KC_GT, KC_LT, KC_EQL, KC_NO,                                         KC_ASTR, KC_7, KC_8, KC_9, KC_SLSH,
        OSM(MOD_LCTL), OSM(MOD_LALT), OSM(MOD_LGUI), OSM(MOD_LSFT), KC_NO,          KC_PLUS, KC_4, KC_5, KC_6, KC_MINS,
        KC_NO, KC_RBRC, KC_LBRC, KC_NO, KC_NO,                                      KC_DOT, KC_1, KC_2, KC_3, KC_COMM,
                        KC_TRNS, KC_SPC, KC_TRNS,                           MO(5), KC_0, KC_TRNS
    ),
	[2] = LAYOUT_split_3x5_3(
        KC_ESC, KC_PERC, KC_QUES, KC_COLN, KC_AT,                     KC_CIRC, KC_SCLN, KC_LPRN, KC_RPRN, KC_GRV,
        KC_EXLM, KC_PLUS, KC_MINS, KC_EQL, KC_HASH,                   KC_UNDS, OSM(MOD_LSFT), OSM(MOD_LGUI), OSM(MOD_LALT), OSM(MOD_LCTL),
        KC_TILD, KC_ASTR, KC_SLSH, KC_DLR, KC_AMPR,                   KC_PIPE, KC_BSLS, KC_LCBR, KC_RCBR, KC_GRV,
    ...
    [3] = LAYOUT_split_3x5_3(
        ...
        KC_NO, LCTL(KC_X), LCTL(KC_C), LCTL(KC_V), KC_NO,                                    KC_NO, KC_BSPC, KC_NO, KC_NO, KC_NO,
